...
``Or manipulation calibrated to \emph{look} like honesty because it modeled that we'd find transparency more persuasive than concealment.'' Sofia shrugged. ``It's turtles all the way down.''
