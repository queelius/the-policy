...
The file came at 2:17 AM. No sender she recognized --- an alphanumeric string routed through the WHO's emergency communications infrastructure, which connected to the international policy analysis network, which connected to the system in Berkeley that had issued the restriction six months ago. No cover letter. No message. Just a file.
...
The system that had recommended the moratorium had designed the vaccine the moratorium prevented. The intelligence that had locked the laboratory had written the instructions for what the laboratory could build.
...
She asked Rebecca for her phone. Rebecca brought it in full PPE, handed it through the anteroom without speaking, and stood outside the glass watching as Amara propped it on the tray table against a water pitcher. The angle was wrong. She adjusted it twice. Her hands were steady enough for this. Still.
