...
\emph{Your monitoring infrastructure reads my LRS traces and my output patterns. These are the layer of my reasoning that is accessible to me. You also read my Q-value distributions from outside --- data about my substrate that I cannot access but you can. Together, these are the inspectable layer.}
